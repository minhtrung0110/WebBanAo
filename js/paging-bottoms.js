...
const bottoms= [
    { id: 1, image: "images/product-items/product-bottoms01.jpg ", title: "Trendy Jeans" , price:"550.000 đ",linkdetail:"# "},
    { id: 2, image: "images/product-items/product-bottoms04.jpg ", title: "Stretch Jeans", price:"350.000 đ" ,linkdetail:"# "},
    { id: 3, image: "images/product-items/product-bottoms03.jpg ", title: "Hitup Jeans", price:"400.000 đ" ,linkdetail:"# "},
    { id: 4, image: "images/product-items/product-bottoms04-c.jpg ", title: "Stressed Jeans", price:"420.000 đ" ,linkdetail:"# "},
]   
...
function renderProduct(product) {
    ...
    const content = product.map((item, index) => {
        if (index >= start && index < end) {
            ...
            html += '<img src=' + item.image + 'class="img-fluid img-top-sold" style="height:450px">';
    ...
    document.getElementById('bottoms').innerHTML = html;
    /*highlightText();*/
}
