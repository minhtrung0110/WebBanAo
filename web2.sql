...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2021 at 07:08 PM
...
(2, 0, 'Đại Ngu', 'dai@gmail.com', '0925368741', 'Nam', 'Quận 9 ,TP HCM'),
...
(2, 1, 'admin', 'admin', 1, 'admin@gmail.com'),
...
--
ALTER TABLE `taikhoan`
  MODIFY `MA_TK` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
